...
from backend.main import app, switch_database, PROJECT_DIR
...
def temp_db():
    ...
    temp_db_path = Path(temp_dir) / "features.db"  # Must be named features.db for create_database

    # Create database
    engine, session_maker = create_database(Path(temp_dir))

    # Switch the app to use this database
    switch_database(temp_db_path)
    ...
    switch_database(PROJECT_DIR / "features.db")
...
class TestCreateFeature:
    ...
    def test_create_feature_success(self, client, temp_db):
    ...
    def test_create_feature_validation_error(self, client, temp_db):
...
class TestUpdateFeature:
    ...
    def test_update_feature_success(self, client, temp_db):
    ...
    def test_update_feature_partial(self, client, temp_db):
    ...
    def test_update_feature_not_found(self, client, temp_db):
...
class TestDeleteFeature:
    ...
    def test_delete_feature_success(self, client, temp_db):
    ...
    def test_delete_feature_not_found(self, client, temp_db):
...
class TestUpdateFeatureState:
    ...
    def test_move_to_in_progress(self, client, temp_db):
    ...
    def test_move_to_done_sets_completed_at(self, client, temp_db):
    ...
    def test_move_from_done_clears_completed_at(self, client, temp_db):
    ...
    def test_update_state_not_found(self, client, temp_db):
...
class TestUpdateFeaturePriority:
    ...
    def test_update_priority_success(self, client, temp_db):
    ...
    def test_update_priority_invalid(self, client, temp_db):
    ...
    def test_update_priority_not_found(self, client, temp_db):
...
class TestMoveFeature:
    ...
    def test_move_up_success(self, client, temp_db):
    ...
    def test_move_down_success(self, client, temp_db):
    ...
    def test_move_up_at_top(self, client, temp_db):
    ...
    def test_move_down_at_bottom(self, client, temp_db):
    ...
    def test_move_respects_lanes(self, client, temp_db):
    ...
    def test_move_invalid_direction(self, client, temp_db):
    ...
    def test_move_not_found(self, client, temp_db):
...
class TestIntegrationScenarios:
    ...
    def test_full_lifecycle(self, client, temp_db):
    ...
    def test_priority_auto_assignment(self, client, temp_db):
