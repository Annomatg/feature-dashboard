...
This command **requires** the project directory as an argument via `F:\Work\Godot\cars-proto\RLTraining`.

**Example:** `/create-spec generations/my-app`

**Output location:** `F:\Work\Godot\cars-proto\RLTraining/prompts/app_spec.txt` and `F:\Work\Godot\cars-proto\RLTraining/prompts/initializer_prompt.md`

If `F:\Work\Godot\cars-proto\RLTraining` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `F:\Work\Godot\cars-proto\RLTraining/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `F:\Work\Godot\cars-proto\RLTraining/prompts/app_spec.txt`
...
**Output path:** `F:\Work\Godot\cars-proto\RLTraining/prompts/initializer_prompt.md`
...
**Output path:** `F:\Work\Godot\cars-proto\RLTraining/prompts/.spec_status.json`
...
> "Your specification files have been created in `F:\Work\Godot\cars-proto\RLTraining/prompts/`!
>
> **Files created:**
> - `F:\Work\Godot\cars-proto\RLTraining/prompts/app_spec.txt`
> - `F:\Work\Godot\cars-proto\RLTraining/prompts/initializer_prompt.md`
>
